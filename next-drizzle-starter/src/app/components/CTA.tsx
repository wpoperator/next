export default function CTA() {
    return (
        <section className="bg-white dark:bg-lime-400">
            <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div className="max-w-screen-md">
                    <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-black"> We find what brings us together.</h2>
                    <p className="mb-8 font-light text-white sm:text-xl dark:text-white">Flowbite helps you connect with friends, family and communities of people who share your interests. Connecting with your friends and family as well as discovering new ones is easy with features like Groups, Watch and Marketplace.</p>
